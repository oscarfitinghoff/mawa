app.controller('woCtrl', function(currentAuth, $scope, dataFactory) {
  ...
  $scope.addWorkout = function() {
    //function getTheWeek
    var theWorkout = {
      theDate: $scope.addWorkoutData.theDate,
      theLocation: $scope.addWorkoutData.theLocation,
      theActivity: $scope.addWorkoutData.theActivity,
      theDuration: $scope.addWorkoutData.theDuration,
      theComment: $scope.addWorkoutData.theComment,
      theWeek: getTheWeek($scope.addWorkoutData.theDate)
    };
